...
| **Reeclaim (reeclaim.co.uk)** | **TfL only**: connect your TfL contactless account, they find every eligible delay, pre-fill the refund, you approve with one tap, they submit; TfL credits your card | Underground / Overground / DLR / Elizabeth line, contactless bank cards only — no National Rail, no Oyster | **Subscription £4.99–£15.99/mo, no cut of refunds.** Claims 149K cards, 375K claims, £1M+ refunded (Sept 2026) |

Reeclaim is the strongest evidence in this table that commuters will pay a subscription for one-tap refunds, and that a subscription sidesteps the money-flow problem of a success fee. A London-commuter feature on the same model is written up as a v2 maybe in [PLAN §10](PLAN.md).
